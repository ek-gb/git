...
Произвел измение в чужом репозитории. Для того, чтобы произвести или предложить свои изменения нам необходимо следующее:
> Делаем форк (fork) интересующего нас репозитория
> Делаем git clone для нашей версии этого репозитория.
> Создаем ветку с предлагаемыми изменнениями.
> Производим все изменения только в этой ветке.
> Отправляем эти изменения на свой аккаунт (git push).
> В окне github появляется возможность отправить наши изменения (pull request)
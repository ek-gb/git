...
**git pull** 
>выкачивает версию из удаленного репозитория в локальный и делает merge 

**git push**
>отправляет версию файла на удаенный репозиторий

**git clone** 
>создает копию удаленного репозитория на локальном ПК
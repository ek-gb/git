...
_*git push*_ - отправь файлы в удаленный репозиторий
_*git remote*_- привяжет репозиторий к url отдаленного репозитория
_*git fetch*_- скачает изменения из удаленного репозитория

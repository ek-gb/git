...
Для просмотра списка ваших удаленных подключений к другим репозиториям нужно  нажать:
> git remote

Для просмотра списка ваших удаленных подключений к другим репозиториям, но включая URL-адрес для каждого подключения нужно нажать:
> git remote -v
...
* Все эти инструкции помогут вам в процессе обучения! 

Как говорил Наполеон Хилл:

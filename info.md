...
Для скачивания содержимого другого репозитория в локальный команда:
> git pull

Для отправки изменений локального репозитория в удаленный командa:
> git push

Для копирования удаленного репозитория на себе ПК командa:
> git clone

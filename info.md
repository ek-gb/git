...
Для клонирования внешнего репозитория на ваш ПК используем команду:
> git clone

Для скачивания текущего репозитория и одновременного объединения изменений используем команду:
> git pull

Для отправки локального репозитория на внешний репозиторий используем команду:
> git push
